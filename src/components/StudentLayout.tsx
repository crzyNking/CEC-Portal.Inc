...
const OPTIONS = [
  ...
  { label: 'Classes', path: '/dashboard#schedule', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg> },
]
...
const ADMINISTRATIVE = [
  ...
  { label: 'Payments', path: '/dashboard#payments', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg> },
  { label: 'Appointments', path: '/dashboard#payments', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><polyline points="9 16 11 18 15 13"/></svg> },
      ...
      <div className="flex items-start min-h-[calc(100vh-52px)]">
        ...
        <aside className={`w-[210px] flex-shrink-0 bg-white border-r border-[#E6E8EE] py-5 px-3 min-h-[calc(100vh-52px)] sticky top-0 z-30 transition-transform duration-200 lg:translate-x-0 ${sidebarOpen ? 'translate-x-0 fixed top-[52px] left-0 h-[calc(100vh-52px)]' : '-translate-x-full lg:translate-x-0'}`}>
          ...
          <div className="mt-[14px] border-t border-[#E6E8EE] pt-[14px]">
            <Link to="/programs" className="flex items-center gap-2.5 px-2.5 py-[9px] rounded-lg text-[13px] font-medium text-[#525A6E] hover:bg-[#F5F7FC] transition-colors">
