      ...
      <div className="max-w-[1140px] mx-auto px-5">
        ...
        <header className="bg-[#0B2046] rounded-2xl overflow-hidden flex flex-col md:flex-row mt-4 mb-10 text-white">
          ...
          <div className="flex-1 relative bg-[#1A202C] min-h-[280px] md:min-h-[320px]">
            <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=800&q=80" alt="Students in Computer Lab" className="w-full h-full object-cover" loading="lazy" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
          ...
          <article className="border border-[#EDF2F7] rounded-xl overflow-hidden bg-white shadow-[0_4px_6px_-1px_rgba(0,0,0,0.03)] flex flex-col md:flex-row">
            ...
            <div className="md:flex-[0.8] relative min-h-[180px]">
              <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=600&q=80" alt="Software Dev Lab" className="w-full h-full object-cover" loading="lazy" />
          ...
          <article className="border border-[#EDF2F7] rounded-xl overflow-hidden bg-white shadow-[0_4px_6px_-1px_rgba(0,0,0,0.03)] flex flex-col">
            <div className="h-[140px] relative">
              <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=800&q=80" alt="Cybersecurity Team" className="w-full h-full object-cover" loading="lazy" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-[1fr_1.3fr] gap-5">
          ...
          <article className="border border-[#EDF2F7] rounded-xl overflow-hidden bg-white shadow-[0_4px_6px_-1px_rgba(0,0,0,0.03)] flex flex-col md:flex-row">
            ...
            <div className="md:flex-[0.8] relative min-h-[180px]">
              <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=600&q=80" alt="Tech Immersion" className="w-full h-full object-cover" loading="lazy" />
