...
const defaultK12 = [
  ...
  { title: 'Elementary', description: 'Grades 1-6 • Building strong academic foundations', path: '/enrollment/elementary', img: 'https://www.facebook.com/d5346f9f-6043-47d1-972c-52727077792a' },
