...
const defaultK12 = [
  { title: 'Kindergarten', description: 'Ages 3-5 • Foundational learning through play-based curriculum', path: '/enrollment/kindergarten', img: 'https://images.unsplash.com/photo-1587654780291-39c9404d7dd0?auto=format&fit=crop&w=600&q=80' },
  ...
  { title: 'Junior High', description: 'Grades 7-10 • Comprehensive secondary education', path: '/enrollment/junior-high', img: 'https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?auto=format&fit=crop&w=600&q=80' },
  { title: 'Senior High', description: 'Grades 11-12 • Specialized tracks and strands', path: '/enrollment/senior-high', img: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=600&q=80' },
]
...
export default function Enrollment() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#0B1F3A] to-[#1E4E8C] text-white pt-28 pb-16 md:pt-36 md:pb-24">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#1E4E8C] rounded-full blur-3xl" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-[#0B1F3A]">K-12 Programs</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {defaultK12.map((level) => (
                <Link
                  key={level.title}
                  to={level.path}
                    className="group block bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-[#1E4E8C]/30 hover:shadow-lg transition-all duration-300"
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-3 flex items-center gap-1 text-[11px] font-bold text-[#1E4E8C] group-hover:text-[#1E4E8C]">
                      Enroll Now
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-[#0B1F3A]">College</h2>
            </div>
            <Link
              to="/enrollment/college"
              className="group block bg-gradient-to-br from-[#0B1F3A] to-[#1E4E8C] text-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300"
            >
              <div className="relative h-[140px] overflow-hidden">
                <img src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&w=600&q=80" alt="College" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
