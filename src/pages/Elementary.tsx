    ...
    <div className="min-h-screen bg-[#EEF1F6] text-[#1C1C1C] overflow-x-hidden">
      ...
      <section className="bg-[#0B1F3A] grid grid-cols-1 md:grid-cols-2 items-center px-6 py-12 md:px-10 md:py-14 gap-6">
        <div className="max-w-[520px]">
          ...
          <a href="/enrollment/elementary" className="inline-block bg-[#F6B93B] text-[#3B2F00] font-bold text-[13px] tracking-wide px-8 py-3.5 rounded-full hover:bg-[#E5A52E] transition-colors">
            ENROLL NOW!
          </a>
        </div>
        <div className="w-full aspect-[4/3] rounded-lg overflow-hidden">
          <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=600&q=80" alt="School Building" className="w-full h-full object-cover" loading="lazy" />
        </div>
      </section>

      {/* Section Title */}
      <div className="text-center pt-12 pb-3 px-5">
        <h2 className="text-[#0B1F3A] text-[30px] mb-2.5">Pre-Elementary Programs</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[1100px] mx-auto px-6 md:px-10 pb-10 mt-8">
        ...
        <div className="bg-white rounded-[10px] overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.05)]">
          <div className="h-[180px]">
            <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=600&q=80" alt="Playroom" className="w-full h-full object-cover" loading="lazy" />
          </div>
          <div className="p-6">
        ...
        <div className="bg-white rounded-[10px] overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.05)] p-6">
          ...
          <ul className="list-none text-[13px] text-[#1C1C1C]">
            <li className="py-1.5 border-t border-[#EEE]">● Exemplary English &amp; Chinese Faculty</li>
            <li className="py-1.5 border-t border-[#EEE]">● Affordable Tuition Fees with Discounts &amp; Privileges</li>
            <li className="py-1.5 border-t border-[#EEE]">● Grounded in Confucian Teachings &amp; Pragmatic Concepts</li>
          </ul>
        </div>
        ...
        <div className="bg-[#0B1F3A] rounded-[10px] overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.05)] grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="hidden md:block">
            <img src="https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=400&q=80" alt="Classroom" className="w-full h-full object-cover" loading="lazy" />
          </div>
        </div>
